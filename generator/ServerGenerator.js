...
const pathDemo='../server/src/main/java/com/example/demo/';
...
const pathGQLDir= '../server/src/main/resources/graphql';

/*-------------VARIABLES FICHEROS--------------------*/
const pathGQLFile= '../server/src/main/resources/graphql/starwarsql.graphqls';
const pathAppPtyFile= '../server/src/main/resources/application.properties';
const pathPom= '../server/pom.xml';
